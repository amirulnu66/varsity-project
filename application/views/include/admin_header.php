...
<aside class="main-sidebar">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview <?php if ($this->uri->segment('1') == ("Caccounts") || $this->uri->segment('1') == ("Account_Controller") || $this->uri->segment('1') == ("Cpayment")) { echo "active";}else{ echo " ";}?>">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview <?php if ($this->uri->segment('2') == ("summaryy") || $this->uri->segment('2') == ("date_summary") || $this->uri->segment('2') == ("custom_report") || $this->uri->segment('2') == ("closing_report")) { echo "active";}else{ echo " ";}?>"><a href=""><?php echo display('report')?></a>
                    <ul class="treeview-menu">
            ...
            <li class="treeview <?php if ($this->uri->segment('1') == ("Creport")) { echo "active";}else{ echo " ";}?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo base_url('Creport/stock_report_product_wise')?>"><?php echo display('stock_report_product_wise') ?></a></li>
                     <li><a href="<?php echo base_url('Creport/stock_report_batch_wise')?>"><?php echo display('stock_report_batch_wise') ?></a></li>
                </ul>
            </li>
            <!-- Stock menu end -->
            ...
            <!-- Personal loan start -->
            <li class="treeview <?php if ($this->uri->segment('2') == ("add1_person") || $this->uri->segment('2') == ("manage1_person")) { echo "active";}else{ echo " ";}?>">
                <a href="#">
            ...
            <!-- Personal loan end -->
             <!--  loan start -->
            <li class="treeview <?php if ($this->uri->segment('2') == ("add_person") || $this->uri->segment('2') == ("add_loan") || $this->uri->segment('2') == ("add_payment") || $this->uri->segment('2') == ("person_edit") || $this->uri->segment('2') == ("manage_person") || $this->uri->segment('2') == ("person_ledger")) { echo "active";}else{ echo " ";}?>">
                <a href="#">
