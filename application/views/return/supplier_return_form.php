                                ...
                                {purchase_all_data}
                                    <tr>
                                        <td class="" style="width: 200px;">
                                            ...
                                            <input type="hidden" name="batch_id[]" id="batch_id_{sl}" value="{batch_id}">
                                        </td>
                                        <td>
                                            <input type="text" name="ret_qty[]" class="form-control text-right " value="{quantity}" readonly="" />
                                             <input type="hidden" name="expire_date[]" id="expire_date_{sl}" value="{expeire_date}">
                                      </td>
                                        <td>
