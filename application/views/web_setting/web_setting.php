                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="currency" id="currency" tabindex="5">
                                    ...
                                    <option value="৳" <?php if ($currency == '৳') { echo "selected";}?>>৳ BDT</option>
                                     <option value="$" <?php if ($currency == '$') { echo "selected";}?>>$ ARS</option>
                                     <option value="$" <?php if ($currency == '$') { echo "selected";}?>>$ AUD</option>
                                     <option value="n/a" <?php if ($currency == 'n/a') { echo "selected";}?>>n/a BHD</option>
                                     <option value="$" <?php if ($currency == '$') { echo "selected";}?>>$ BBD</option>
                                     <option value="£" <?php if ($currency == '£') { echo "selected";}?>>£ GBP</option>
                                     <option value="$" <?php if ($currency == '$') { echo "selected";}?>>$ CAD</option>
                                     <option value="n/a" <?php if ($currency == 'n/a') { echo "selected";}?>>n/a  XAF</option>
                                    <option value="$" <?php if ($currency == '$') { echo "selected";}?>>$ CLP</option>
                                    <option value="元" <?php if ($currency == '元') { echo "selected";}?>>元 CNY</option>
                                   <option value="kr" <?php if ($currency == 'kr') { echo "selected";}?>>kr  DKK</option>
                                   <option value="n/a" <?php if ($currency == 'n/a') { echo "selected";}?>>n/a CYP</option>
                                    <option value="Kč" <?php if ($currency == 'Kč') { echo "selected";}?>>Kč CZK</option>
                                    <option value="元" <?php if ($currency == '元') { echo "selected";}?>>元 HKD</option>
                                    <option value="Rp" <?php if ($currency == 'Rp') { echo "selected";}?>>Rp IDR</option>
                                     <option value="J$" <?php if ($currency == 'J$') { echo "selected";}?>>J$ JMD</option>
                                     <option value="¥" <?php if ($currency == '¥') { echo "selected";}?>>¥ JPY</option>
                                     <option value="n/a" <?php if ($currency == 'n/a') { echo "selected";}?>>n/a JOD</option>
                                      <option value="n/a" <?php if ($currency == 'n/a') { echo "selected";}?>>n/a KES</option>
                                      <option value="£" <?php if ($currency == '£') { echo "selected";}?>>£ LBP</option>
                                       <option value="Ls" <?php if ($currency == 'Ls') { echo "selected";}?>>Ls LVL</option>
                                       <option value="£" <?php if ($currency == '£') { echo "selected";}?>>£ LBP</option>
                                     <option value="RM" <?php if ($currency == 'RM') { echo "selected";}?>>RM MYR</option>
                                     <option value="$" <?php if ($currency == '$') { echo "selected";}?>>$ MXN</option>
                                     <option value="n/a" <?php if ($currency == 'n/a') { echo "selected";}?>>n/a MAD</option>
                                    <option value="$" <?php if ($currency == '$') { echo "selected";}?>>$ NAD</option>
                                    <option value="Rs" <?php if ($currency == 'Rs') { echo "selected";}?>>Rs NPR</option>
                                    <option value="$" <?php if ($currency == '$') { echo "selected";}?>>$  NZD</option>
                                    <option value="kr" <?php if ($currency == 'kr') { echo "selected";}?>>kr NOK</option>
                                    <option value="﷼" <?php if ($currency == '﷼') { echo "selected";}?>>﷼ OMR</option>
                                     <option value="Ph" <?php if ($currency == 'Ph') { echo "selected";}?>>Ph PHP</option>
                                    <option value="﷼" <?php if ($currency == '﷼') { echo "selected";}?>>﷼ QAR</option>
                                     <option value="₽" <?php if ($currency == '₽') { echo "selected";}?>>₽ RUB</option>
                                    <option value="﷼" <?php if ($currency == '﷼') { echo "selected";}?>>﷼ SAR</option>
                                    <option value="$" <?php if ($currency == '$') { echo "selected";}?>>$ SGD</option>
                                    <option value="R" <?php if ($currency == 'R') { echo "selected";}?>>R ZAR</option>
                                    <option value="Rs" <?php if ($currency == 'Rs') { echo "selected";}?>>Rs LKR</option>
                                     <option value="kr" <?php if ($currency == 'kr') { echo "selected";}?>>kr SEK</option>
                                     <option value="CHF" <?php if ($currency == 'CHF') { echo "selected";}?>> CHF</option>
                                     <option value="฿" <?php if ($currency == '฿') { echo "selected";}?>>฿ THB</option>
                                     <option value="YTL" <?php if ($currency == 'YTL') { echo "selected";}?>>YTL TRY</option>
                                     <option value="n/a" <?php if ($currency == 'n/a') { echo "selected";}?>>n/a AED</option>
                                    <option value="Bs" <?php if ($currency == 'Bs') { echo "selected";}?>>Bs VEF</option>
                                    <option value="n/a" <?php if ($currency == 'n/a') { echo "selected";}?>>n/a XOF</option>
                                </select>
                            </div>
                        </div>
